...
def trigger_deployment(
    ...
    try:
        ...
        return {"success": False, "run_id": None, "run_url": "", "status": "FAILED", "error": str(exc)}
    ...
    if not run_id:
        return {"success": False, "run_id": None, "run_url": "", "status": "FAILED", "error": "Run not found after dispatch"}
